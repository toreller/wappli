...
public abstract class QueryService<ENTITY, CRITERIA> {

    public abstract List<ENTITY> findByCriteria(CRITERIA criteria);
    public abstract Page<ENTITY> findByCriteria(CRITERIA criteria, Pageable page);
